...
def build_davinci_tracker():
    ...
    subprocess.run(cmd, check=True)
    shutil.copy(Path("dist") / "TrackFlowDaVinci", DIST_DIR / "TrackFlowDaVinci")
    (DIST_DIR / "TrackFlowDaVinci").chmod(0o755)
    os.chdir(ROOT_DIR)
...
if __name__ == "__main__":
    try:
        ...
        print("  - TrackFlowDaVinci  (DaVinci app-context tracker)")
        print(f"{'='*60}")
